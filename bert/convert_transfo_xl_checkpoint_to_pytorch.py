...
import model.tokenization_transfo_xl as data_utils
from bert.modeling_transfo_xl import (CONFIG_NAME,
                                                         WEIGHTS_NAME,
                                                         TransfoXLConfig,
                                                         TransfoXLLMHeadModel,
                                                         load_tf_weights_in_transfo_xl)
from bert.tokenization_transfo_xl import (CORPUS_NAME,
                                                             VOCAB_NAME)
